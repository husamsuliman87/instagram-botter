...
def __main__:
 ...
 print("");print("[1] - Likes ");print("");print("[2] - Views ");print("");print("[1] - Followers ");print("");
   choose=input('> ')
       if choose=="1":
          url=input('https://www.instagram.com/p/DUKJYokiIkj/ (your account need to be public')
          if req.url==False:
       ...
       url=input("https://www.instagram.com/stories/highlights/18069777815405306/ (need to be public and can be found on instagram's computer version")
          if req.url==False:
       ...
       req.new accounts 
          ...
          print("welcome to the followers botter for Instagram") 
              print("")
                  print("please donate $0 to this paypal to access the follower gen")
